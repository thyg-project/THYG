...
@interface THGWQFViewController () <UITableViewDelegate, UITableViewDataSource> {
...
@implementation THGWQFViewController

- (void)viewDidLoad {
    [super viewDidLoad];
    self.navigationItem.title = @"购物全返";
    [self setup];
}
