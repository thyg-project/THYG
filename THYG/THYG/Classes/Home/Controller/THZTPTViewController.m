...
@interface THZTPTViewController ()<UITableViewDelegate, UITableViewDataSource> {
...
@implementation THZTPTViewController

- (void)viewDidLoad {
    [super viewDidLoad];
    self.navigationItem.title = @"组团拼团";
    [self setup];
}
