...
- (THGoodsDetailBottomView *)bottomView {
    if (!_bottomView) {
        _bottomView = [[THGoodsDetailBottomView alloc] initWithFrame:CGRectMake(0, kScreenHeight-kNaviHeight-50, kScreenWidth, 50)];
    }
    return _bottomView;
}
...
- (UIScrollView *)scrollView {
    if (!_scrollView) {
        ...
        _scrollView.frame = CGRectMake(0, 0, kScreenWidth, kScreenHeight-kNaviHeight-50);
