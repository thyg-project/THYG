...
- (SDCycleScrollView *)cycleScrollView {
    if (!_cycleScrollView) {
        _cycleScrollView = [SDCycleScrollView cycleScrollViewWithFrame:CGRectZero delegate:self placeholderImage:[UIImage imageNamed:@"zhutu"]];
        _cycleScrollView.pageDotColor = [[UIColor whiteColor] colorWithAlphaComponent:0.6];
