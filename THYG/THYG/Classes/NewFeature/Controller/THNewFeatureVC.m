...
- (void)setupCollectionView {
	...
	[self.collectionView registerClass:[THNewFeatureCell class] forCellWithReuseIdentifier:NSStringFromClass(THNewFeatureCell.class)];
...
- (void)setupPageControl {
	self.pageControl = ({
		...
		[pageControl setValue:[UIImage imageNamed:@"yuandian"] forKey:@"pageImage"];
		[pageControl setValue:[UIImage imageNamed:@"yuandiandongxiao"] forKey:@"currentPageImage"];
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath {
	...
	THNewFeatureCell *cell = [collectionView dequeueReusableCellWithReuseIdentifier:NSStringFromClass(THNewFeatureCell.class) forIndexPath:indexPath];
	// 设置cell ImageView
